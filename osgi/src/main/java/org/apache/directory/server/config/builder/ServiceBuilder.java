...
/**
 * A class used for reading the configuration present in a Partition and
 * instantiate the necessary objects like DirectoryService, Interceptors etc.
 *
...
public final class ServiceBuilder
{
    ...
    /**
     * creates the PassworddPolicyConfiguration object after reading the config
     * entry containing pwdpolicy OC
     *
     * @param PasswordPolicyBean The Bean containing the PasswordPolicy
     * configuration
     * @return the {@link PasswordPolicyConfiguration} object, null if the
     * pwdpolicy entry is not present or disabled
     */
     ...
     *
     * @param saslMechHandlerEntry the entry of OC type
     * {@link ConfigSchemaConstants#ADS_LDAP_SERVER_SASL_MECH_HANDLER_OC}
     * @return an instance of the MechanismHandler type
     * @throws ConfigurationException if the SASL mechanism handler cannot be
     * created
     */
     ...
     * @return An instance of authenticator if the given authenticatorBean is
     * not disabled
     */
    ...
    /**
     * Helper method to create an Array of EncryptionTypes from an array of
     * Strings
     */
    ...
    /**
     * Instantiates a NtpServer based on the configuration present in the
     * partition
     *
     * @param ntpServerBean The NtpServerBean containing the NtpServer
     * configuration
    ...
    /**
     * Instantiates a DhcpServer based on the configuration present in the
     * partition
     *
     * @param dhcpServerBean The DhcpServerBean containing the DhcpServer
     * configuration
     * @return Instance of DhcpServer
     * @throws LdapException
     *
     * public static DhcpServer createDhcpServer( DhcpServerBean dhcpServerBean,
     * DirectoryService directoryService ) throws LdapException { // Fist, do
     * nothing if the DhcpServer is disabled if ( !dhcpServerBean.isEnabled() )
     * { return null; }
     *
     * DhcpServer dhcpServer = new DhcpServer();
     *
     * // The service ID dhcpServer.setServiceId( dhcpServerBean.getServerId()
     * );
     *
     * // The transports Transport[] transports = createTransports(
     * dhcpServerBean.getTransports() ); dhcpServer.setTransports( transports );
     *
     * return dhcpServer; }
     *
     *
     * /**
     * Instantiates a KdcServer based on the configuration present in the
     * partition
     *
     * @param kdcServerBean The KdcServerBean containing the KdcServer
     * configuration
    ...
    /**
     * Instantiates a ChangePasswordServer based on the configuration present in
     * the partition
     *
     * @param ldapServerBean The ChangePasswordServerBean containing the
     * ChangePasswordServer configuration
     * @return Instance of ChangePasswordServer
     * @throws LdapException
     *
     * public static ChangePasswordServer createChangePasswordServer(
     * ChangePasswordServerBean changePasswordServerBean, DirectoryService
     * directoryService ) throws LdapException { // Fist, do nothing if the
     * LdapServer is disabled if ( ( changePasswordServerBean == null ) ||
     * changePasswordServerBean.isDisabled() ) { return null; }
     *
     * ChangePasswordServer changePasswordServer = new ChangePasswordServer();
     * changePasswordServer.setEnabled( true );
     * changePasswordServer.setDirectoryService( directoryService );
     *
     * // AllowableClockSkew changePasswordServer.setAllowableClockSkew(
     * changePasswordServerBean.getKrbAllowableClockSkew() );
     *
     * // TODO CatalogBased //changePasswordServer.setCatalogBased(
     * changePasswordServerBean.isCatalogBase() );
     *
     * // EmptyAddressesAllowed changePasswordServer.setEmptyAddressesAllowed(
     * changePasswordServerBean.isKrbEmptyAddressesAllowed() );
     *
     * // EncryptionTypes EncryptionType[] encryptionTypes =
     * createEncryptionTypes( changePasswordServerBean.getKrbEncryptionTypes()
     * ); changePasswordServer.setEncryptionTypes( encryptionTypes );
     *
     * // PolicyCategoryCount changePasswordServer.setPolicyCategoryCount(
     * changePasswordServerBean.getChgPwdPolicyCategoryCount() );
     *
     * // PolicyPasswordLength changePasswordServer.setPolicyPasswordLength(
     * changePasswordServerBean.getChgPwdPolicyPasswordLength() );
     *
     * // policyTokenSize changePasswordServer.setPolicyTokenSize(
     * changePasswordServerBean.getChgPwdPolicyTokenSize() );
     *
     * // PrimaryRealm changePasswordServer.setPrimaryRealm(
     * changePasswordServerBean.getKrbPrimaryRealm() );
     *
     * // SearchBaseDn changePasswordServer.setSearchBaseDn(
     * changePasswordServerBean.getSearchBaseDn().getName() );
     *
     * // Id/Name changePasswordServer.setServiceName(
     * changePasswordServerBean.getServerId() );
     * changePasswordServer.setServiceId( changePasswordServerBean.getServerId()
     * );
     *
     * // ServicePrincipal changePasswordServer.setServicePrincipal(
     * changePasswordServerBean.getChgPwdServicePrincipal() );
     *
     * // Transports Transport[] transports = createTransports(
     * changePasswordServerBean.getTransports() );
     * changePasswordServer.setTransports( transports );
     *
     * return changePasswordServer; }
     */
    /**
     * Instantiates a LdapServer based on the configuration present in the
     * partition
     *
     * @param ldapServerBean The LdapServerBean containing the LdapServer
     * configuration
    ...
    /**
     * instantiate the ReplicationConsumers based on the configuration present
     * in ReplConsumerBeans
     *
    ...
    /**
     * Instantiates a DirectoryService based on the configuration present in the
     * partition
     *
    ...
    /**
     * Create a new instance of a MavibotIndex from an instance of
     * MavibotIndexBean
     *
